...
class PlnController extends Controller
{
            ...
            $data[] = array(
                ...
                '<div style="float: left; margin-left: 5px;">
                                <button type="button" class="btn btn-danger deleteData"
                                 data="data_customer"  id="' . $d->id_pelanggan . '" aksi="delete" tujuan="customer" style="min-width: 110px;margin-left: 2px;margin-top:3px;text-align:left">
    ...
    {
        $data_id_customer = DB::table('table_pln_customer')->where('id_pelanggan', $id)->first();
        $id_customer = $data_id_customer->id;
        $delete = DB::table('table_pln_customer')->where('id_pelanggan', $id)->delete();
